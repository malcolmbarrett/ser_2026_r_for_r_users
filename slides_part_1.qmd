...
# Activity {.activity-slide background-color="#0072B2"}
...
Start rewriting the script (save a new, better version to work on)
...
## You can pull numbers directly from tables {.smaller}
...
## Turn the analysis into a report {.activity-slide}
